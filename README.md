# Exercise 06 — CI/CD Pipeline (GitHub Actions)
...
|------|-------|-------------------|
| **U5.1-U5.4 DevOps and CI/CD** | pipelines, Docker images, deployments | Create a GitHub Actions workflow that builds, tests, and pushes the Docker image to GHCR. |
...
**Deadline: June 22, 2026 at 23:59 UTC-3** (3 late days allowed with penalty)

---

## Context

Create a GitHub Actions workflow that builds, tests, and pushes the Docker image to GHCR.
